class ThermostatSliderUI
  ...
  def web_add_main_button()
    ...
    # HTML range отправляет целое число, умноженное на 10.
    ...
    # JavaScript отправляем через content_send().
  ...
  def web_sensor()
    # Проверяем наличие аргумента set_temp_int.
    if webserver.has_arg("set_temp_int")
      ...
      # Отправляем новую уставку в термостат.
